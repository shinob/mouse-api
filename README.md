...
# または Red Hat系の場合
sudo yum install tkinter python3-devel tesseract tesseract-langpack-jpn
```

### macOS
```bash
# Homebrewを使用している場合
brew install python-tk tesseract tesseract-lang
```
...
**パラメータ:**
- `text` (必須): 検索する文字列
- `lang` (オプション): OCR言語設定、デフォルト: `jpn+eng`
